...
if (!class_exists('MassiveCryptoData')) {

    class MassiveCryptoData {
        ...
        public function __construct() {
            ...
            $this->config = array(
                ...
                'license_key' => '',
                'license_action' => '',
                'default_currency_format' => array('iso' => 'USD', 'symbol' => '', 'position' => '{symbol}{price}', 'thousands_sep' => ',', 'decimals_sep' => '.', 'decimals' => 2),
                'currency_format' => array(
                    array('iso' => 'USD', 'symbol' => '$', 'position' => '{symbol}{space}{price}', 'thousands_sep' => ',', 'decimals_sep' => '.', 'decimals' => 2),
                    array('iso' => 'EUR', 'symbol' => '€', 'position' => '{price}{space}{symbol}', 'thousands_sep' => '.', 'decimals_sep' => ',', 'decimals' => 2),
                    array('iso' => 'INR', 'symbol' => '₹', 'position' => '{symbol}{space}{price}', 'thousands_sep' => ',', 'decimals_sep' => '.', 'decimals' => 2),
                )
            );
            ...
            $this->options = array(
                ...
                'theme' => 'white',
                'ticker_design' => 1,
                'ticker_position' => 'header',
                'ticker_speed' => 100,
                'ticker_columns' => array('logo'),
                'table_style' => 'light',
                'table_length' => 25,
                'table_columns' => array('rank', 'name', 'price_usd', 'market_cap_usd', 'volume_usd_24h', 'available_supply', 'percent_change_24h', 'weekly'),
                'chart_type' => 'chart',
                'chart_view' => 'day',
                'chart_theme' => 'light',
                'chart_smooth' => 'true',
                'card_design' => 1,
                'label_design' => 1,
                'display_columns' => array('fullwidth', 'rounded', 'images'),
                'converter_type' => 'crypto-to-fiat',
                'converter_button' => '',
                'box_design' => 1,
                'list_design' => 1,
                'changelly_link' => '',
                'changelly_send' => array('BTC'),
                'changelly_send_all' => '',
                'changelly_receive' => array('ETH'),
                'changelly_receive_all' => '',
                'changelly_amount' => 1,
                'changelly_theme' => 'default',
                'multi_currencies' => array('USD', 'EUR', 'GBP'),
                'news_feeds' => 'https://cointelegraph.com/feed',
                'news_count' => 5,
                'news_length' => 25,
                'settings' => array(),
                'currency' => 'USD',
            ...
            $this->providers = array(
                'coingecko' => MCW_URL . 'assets/admin/img/coingecko.png',
                'coinmarketcap' => MCW_URL . 'assets/admin/img/coinmarketcap.svg'
            );
        }
